...
## contains functions for clayton copula approach
##
...
clayton.cc.stage.T1T2.D.lik = function(X0, thetas, S1.hat, S2.hat, SD.hat) {
  ...
  if (nrow(case1.1) != 0) {
    L.part1.1 = with(case1.1, clayton.C21(clayton.C..(S1, S2, theta), SD, theta0) *
  ...
  if (nrow(case1.2) != 0) {
    L.part1.2 = with(case1.2, clayton.C11(clayton.C..(S1, S2, theta), SD, theta0) *
      clayton.C1.(S1, S2, theta))
  } else {
    L.part1.2 = 0
  }
  ...
  if (nrow(case1.3) != 0) {
    L.part1.3 = with(case1.3, clayton.C11(clayton.C..(S1, S2, theta), SD, theta0) *
      clayton.C.1(S1, S2, theta))
  } else {
    L.part1.3 = 0
  }
  ...
  if (nrow(case1.4) != 0) {
    L.part1.4 = with(case1.4, clayton.C.1(clayton.C..(S1, S2, theta), SD, theta0))
  } else {
    L.part1.4 = 0
  }
  ...
  if (nrow(case2.1) != 0) {
    L.part2.1 = with(case2.1, clayton.C2.(clayton.C..(S1, S2, theta), SD, theta0) *
      clayton.C.1(S1, S2, theta) *
      clayton.C1.(S1, S2, theta) +
  ...
  if (nrow(case2.2) != 0) {
    L.part2.2 = with(case2.2, clayton.C1.(clayton.C..(S1, S2, theta), SD, theta0) *
      clayton.C1.(S1, S2, theta))
  } else {
    L.part2.2 = 0
  }
  ...
  if (nrow(case2.3) != 0) {
    L.part2.3 = with(case2.3, clayton.C1.(clayton.C..(S1, S2, theta), SD, theta0) *
      clayton.C.1(S1, S2, theta))
  } else {
    L.part2.3 = 0
  }
  ...
  if (nrow(case2.4) != 0) {
    L.part2.4 = with(case2.4, clayton.C..(clayton.C..(S1, S2, theta), SD, theta0))
  } else {
    L.part2.4 = 0
  }
...
####################################################################################################
#                                    Clayton Copula Source Functions                              #
####################################################################################################
...
# clayton.dtheta.C11 = function(u1, u2, theta) {}
# body(clayton.dtheta.C11) = D(D(D(C.clayton.expr, "u1"), "u2"), "theta")
# clayton.dtheta.C.1 = function(u1, u2, theta) {}
# body(clayton.dtheta.C.1) = D(D(C.clayton.expr, "u2"), "theta")
# clayton.dtheta.C1. = function(u1, u2, theta) {}
# body(clayton.dtheta.C1.) = D(D(C.clayton.expr, "u1"), "theta")
# clayton.dtheta.C.. = function(u1, u2, theta) {}
# body(clayton.dtheta.C..) = D(C.clayton.expr, "theta")
# 
# clayton.dtheta2.C11 = function(u1, u2, theta) {}
# body(clayton.dtheta2.C11) = D(D(D(D(C.clayton.expr, "u1"), "u2"), "theta"), "theta")
# clayton.dtheta2.C1. = function(u1, u2, theta) {}
# body(clayton.dtheta2.C1.) = D(D(D(C.clayton.expr, "u1"), "theta"), "theta")
# clayton.dtheta2.C.1 = function(u1, u2, theta) {}
# body(clayton.dtheta2.C.1) = D(D(D(C.clayton.expr, "u2"), "theta"), "theta")
# clayton.dtheta2.C.. = function(u1, u2, theta) {}
# body(clayton.dtheta2.C..) = D(D(C.clayton.expr, "theta"), "theta")
# 
# 
# C.clayton.expr.3d = cdfExpr.Clayton(3)
# clayton.C111 = function(u1, u2, u3, theta) {}
# body(clayton.C111) = D(D(D(C.clayton.expr.3d, "u1"), "u2"), "u3")
# clayton.C101 = function(u1, u2, u3, theta) {}
# body(clayton.C101) = D(D(C.clayton.expr.3d, "u1"), "u3")
# clayton.C011 = function(u1, u2, u3, theta) {}
# body(clayton.C011) = D(D(C.clayton.expr.3d, "u2"), "u3")
# clayton.C001 = function(u1, u2, u3, theta) {}
# body(clayton.C001) = D(C.clayton.expr.3d, "u3")
# 
# clayton.C110 = function(u1, u2, u3, theta) {}
# body(clayton.C110) = D(D(C.clayton.expr.3d, "u1"), "u2")
# clayton.C100 = function(u1, u2, u3, theta) {}
# body(clayton.C100) = D(C.clayton.expr.3d, "u1")
# clayton.C010 = function(u1, u2, u3, theta) {}
# body(clayton.C010) = D(C.clayton.expr.3d, "u2")
# clayton.C000 = function(u1, u2, u3, theta) {}
# body(clayton.C000) = C.clayton.expr.3d
# 
...
# 
# g1. = function(w1, w2, theta) {}
# body(g1.) = D(g.expression, "w1")
# g.1 = function(w1, w2, theta) {}
# body(g.1) = D(g.expression, "w2")
# dtheta.g = function(w1, w2, theta) {}
# body(dtheta.g) = D(g.expression, "theta")
# dw1.g = function(w1, w2, theta) {}
# body(dw1.g) = D(g.expression, "w1")
# dw2.g = function(w1, w2, theta) {}
# body(dw2.g) = D(g.expression, "w2")
# 
# dtheta.g1. = function(w1, w2, theta) {}
# body(dtheta.g1.) = D((D(g.expression, "w1")), "theta")
# dtheta2.g = function(w1, w2, theta) {}
# body(dtheta2.g) = D(D(g.expression, "theta"), "theta")
# dtheta2.g1. = function(w1, w2, theta) {}
# body(dtheta2.g1.) = D(D((D(g.expression, "w1")), "theta"), "theta")
# 
...
# 
# clayton.logL = function(d1, dD, u1, u2, w1, w2, theta) {}
# body(clayton.logL) = clayton.logL.expr
# clayton.dtheta.logL = function(d1, dD, u1, u2, w1, w2, theta) {}
# body(clayton.dtheta.logL) = D(clayton.logL.expr, "theta")
# clayton.dtheta2.logL = function(d1, dD, u1, u2, w1, w2, theta) {}
# body(clayton.dtheta2.logL) = D(D(clayton.logL.expr, "theta"), "theta")
# 
# clayton.logL_12 = function(d1, d2, u1, u2, theta) {}
# body(clayton.logL_12) = clayton.logL.expr_12
# clayton.dtheta.logL_12 = function(d1, d2, u1, u2, theta) {}
# body(clayton.dtheta.logL_12) = D(clayton.logL.expr_12, "theta")
# clayton.dtheta2.logL_12 = function(d1, d2, u1, u2, theta) {}
# body(clayton.dtheta2.logL_12) = D(D(clayton.logL.expr_12, "theta"), "theta")
# 
...
#   + (1 - d1) * (1 - dD) * log((1 + (u1^(-theta) - 1 + u2^(-theta) - 1))^(-1 / theta)))
# 
# clayton.dtheta.logL.naive = function(d1, dD, u1, u2, theta) {}
# body(clayton.dtheta.logL.naive) = D(clayton.logL.expr.naive, "theta")
# clayton.dtheta2.logL.naive = function(d1, dD, u1, u2, theta) {}
# body(clayton.dtheta2.logL.naive) = D(D(clayton.logL.expr.naive, "theta"), "theta")
# 
...
# )
# clayton.dtheta.logL.T1T2D = function(d1, d2, d3, u1, u2, u3, theta) {}
# body(clayton.dtheta.logL.T1T2D) = D(clayton.logL.expr.T1T2D, "theta")
# clayton.dtheta2.logL.T1T2D = function(d1, d2, d3, u1, u2, u3, theta) {}
# body(clayton.dtheta2.logL.T1T2D) = D(D(clayton.logL.expr.T1T2D, "theta"), "theta")
